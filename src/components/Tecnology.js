...
import launchImgResponsive from '../assets/technology/image-launch-vehicle-landscape.jpg'
import spaceportImg from '../assets/technology/image-spaceport-portrait.jpg'
import spaceportImgResponsive from '../assets/technology/image-spaceport-landscape.jpg'
import capsuleImg from '../assets/technology/image-space-capsule-portrait.jpg'
import capsuleImgResponsive from '../assets/technology/image-space-capsule-landscape.jpg'
...
function Tecnology() {
    const vehicle = {
        color: '',
        img: launchImg,
        imgResponsive: launchImgResponsive,
        h4: 'Launch Vehicle',
    ...
    const spaceport = {
        img: spaceportImg,
        imgResponsive: spaceportImgResponsive,
        h4: 'Spaceport',
    ...
    const capsule = {
        img: capsuleImg,
        imgResponsive: capsuleImgResponsive,
        h4: 'Space Capsule',
                    ...
                    <div>
                        <div className="sec3-text-content">
                            ...
                            <div className="sec3-bullets-text">
                                <div className="sec3-img-responsive">
                                    <img src={content.imgResponsive} alt="" />
                                </div>
